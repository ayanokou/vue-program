	...
	public static void main(String[] args) {
		...
		server.addEventListener("chatevent", ChatObject.class, new DataListener<ChatObject>() {
			...
			public void onData(SocketIOClient client, ChatObject data, AckRequest ackRequest) {
				...
				// String ImgBase64 =
				// data.getMessage().replaceAll("(data:image/jpeg|data:image/png|data:image/bmp);base64,",
				// "");
...
//// server.addEventListener("flowInformation", demoMessage.class, new
//// DataListener<demoMessage>() {
//// private String imagePath;
////
//// @Override
//// public void onData(SocketIOClient client, demoMessage dm, AckRequest
//// ackRequest) {
...
//// ParamOfSameCenterCircle.ByValue Param = new
//// ParamOfSameCenterCircle.ByValue();
//// while(!Tree.isEmpty()){
//// treenode =Tree.pop();
...
//// Circle.ByValue EDCircleResult =
//// EDCircle.EDCircleBySameCenterCircle.INSTANCE.EDCircle(Param);
 ...
 * public String hello_req(@RequestParam(value = "name", defaultValue = "World")
 * String name) {
 ...
 * // System.out.println("The text is "+jm.getText()+" and the number is "+jm.
 * getNum());
 * //}
 */
 ...
 * 
 * @ResponseBody
 * public String addImage(@RequestParam(name = "image_data", required = false)
 * MultipartFile file) {
 * //文件上传
