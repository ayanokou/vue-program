                    ...
                    <!-- 这里根据点击不同的图标显示不同的内容 -->
                        ...
                        <div v-if="activeIcon === 'receive'" class="mainfield-setting">
                            ...
                            <el-row class="content-head" style=" color:#ffffff ;">
                                <el-col>开机软件自启动  <el-switch v-model="value1" /></el-col>
                            </el-row>
                            <el-row class="content-head" style=" color:#ffffff ;">
                                <el-col>默认运行界面 <el-switch v-model="value2" /></el-col>
                            </el-row>
                            <el-row class="content-head" style=" color:#ffffff ;">
                                <el-col>运行界面独立启动时最大化 <el-switch v-model="value3" /></el-col>
                            </el-row>
                            <el-row class="content-head" style=" color:#ffffff ;">
                                <el-col>文件自动加载 <el-switch v-model="value4" /></el-col>
                            </el-row>
                            <el-row class="content-head" style=" color:#ffffff ;">
                                <el-col>载入路径 <el-input v-model="input" placeholder="Please input" /></el-col>
                            </el-row>
                            <el-row class="content-head" style=" color:#ffffff ;">
                                <el-col>方案密码 <el-input v-model="input" placeholder="Please input" /></el-col>
                            </el-row>
                            <el-row class="content-head" style=" color:#ffffff ;">
                                <el-col>启动状态 <el-input v-model="input" placeholder="Please input" /></el-col>
                            </el-row>
                            <el-row class="content-head" style=" color:#ffffff ;">
                                <el-col>选择身份 <el-input v-model="input" placeholder="Please input" /></el-col>
                            </el-row>
