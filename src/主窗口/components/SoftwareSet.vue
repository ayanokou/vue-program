      ...
      <el-row :gutter="20" class="row-container">
        <el-col :span="4" class="left-column">
          ...
          <div class="sidebar-content">
            <div
              class="sidebar-item"
              :class="{ active: activeIcon === 'deviceManagement' }"
            ...
            <div
              class="sidebar-item"
              :class="{ active: activeIcon === 'receive' }"
              @click="setActiveIcon('receive')"
            >
            ...
            <div
              class="sidebar-item"
              :class="{ active: activeIcon === 'send' }"
              @click="setActiveIcon('send')"
            >
            ...
            <div
              class="sidebar-item"
              :class="{ active: activeIcon === 'heartbeat' }"
              @click="setActiveIcon('heartbeat')"
            >
        ...
        <el-col :span="20" class="right-column">
          ...
          <div class="right-content">
            <!-- 这里根据点击不同的图标显示不同的内容 -->
            <div
              v-if="activeIcon === 'deviceManagement'"
              class="mainfield-setting"
            >
              <el-row style="height: 100%">
                ...
                <el-col :span="18">
                  <el-row
                    class="content-head"
                    style="height: 60%; border-bottom: 1px solid #ccc"
                  >
                    <el-col>通信参数</el-col>
                    <div class="content" v-if="demoSelectedTCP === true">
                      ...
                      <span class="content" v-if="!isIPValid" style="color: red"
                        >请输入合法的 IP 地址</span
                      >
                      <div class="content-row">
                      ...
                      <el-radio-group v-model="updataValue">
                        ...
                        <el-radio :label="false" class="content"
                          >False</el-radio
                        >
                      </el-radio-group>
            ...
            <div v-if="activeIcon === 'receive'" class="mainfield-setting">
              ...
              <el-row class="content-head" style="color: #ffffff">
                <el-col
                  >开机软件自启动
                  <el-switch v-model="softwareParam.selfStartOfStartupSoftware"
                /></el-col>
              </el-row>
              <el-row class="content-head" style="color: #ffffff">
                <el-col
                  >默认运行界面
                  <el-switch v-model="softwareParam.defaultRunInterface"
                /></el-col>
              </el-row>
              <el-row class="content-head" style="color: #ffffff">
                <el-col
                  ...
                  <el-switch
                    v-model="
                      softwareParam.maximizeRuntimeInterfaceStartsIndependently
                    "
                /></el-col>
              </el-row>
              <el-row class="content-head" style="color: #ffffff">
                <el-col
                  >文件自动加载
                  <el-switch v-model="softwareParam.fileAutomaticLoading"
                /></el-col>
              </el-row>
              <el-row class="content-head" style="color: #ffffff">
                <el-col
                  >载入路径
                  <el-input
                    v-model="softwareParam.loadPath"
              ...
              <el-row class="content-head" style="color: #ffffff">
                <el-col
                  >方案密码
                  <el-input
                    v-model="softwareParam.schemepassword"
                    placeholder="Please input"
                /></el-col>
              </el-row>
              <el-row class="content-head" style="color: #ffffff">
                <el-col
                  >启动状态
                  <el-input
                    v-model="softwareParam.startupStatus"
                    placeholder="Please input"
                /></el-col>
              </el-row>
              <el-row class="content-head" style="color: #ffffff">
                <el-col
                  >选择身份
                  <el-input
                    v-model="softwareParam.chooseIdentity"
                    placeholder="Please input"
                /></el-col>
              </el-row>
              <el-row
              ...
              >
                ...
                <div class="mb-2 flex items-center text-sm">
                  <el-radio-group
                    v-model="softwareParam.softwareShutdownSettings"
                    class="ml-4"
                  >
            ...
            <div v-if="activeIcon === 'send'" class="mainfield-setting">
              <el-row style="height: 100%">
                ...
                <el-col :span="18">
                  <el-row
                    class="content-head"
                    style="height: 25%; border-bottom: 1px solid #ccc"
                  >
                    <el-col>绑定设备</el-col>
                  </el-row>
                  <el-row
